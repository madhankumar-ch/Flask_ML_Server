...
df = pd.read_csv(os.path.join(BASE_DIR, "data", "stores_sales_forecasting.csv"), encoding='latin1')
...
# load model
model = joblib.load(os.path.join(BASE_DIR, "model", "furniture_sales_forecast_model"))
